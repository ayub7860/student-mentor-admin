    ...
    >
      ...
      <div>
        <ul key={'dashboard'} className='mb-2 mt-0.5 pl-1 flex flex-col gap-1'>
          ...
          <li key={'company profile master'} className="text-md">
            <NavLink to={`/student/company-profile-master`}>
              {({isActive}) => (
                <Button
                  variant={isActive ? "gradient" : "text"}
                  onClick={() => {
          ...
          <li key={'student master'} className="text-md">
            <NavLink to={`/student/notice-master`}>
              {({isActive}) => (
                <Button
                  variant={isActive ? "gradient" : "text"}
                  onClick={() => {
          ...
          <li key={'student report master'} className="text-md">
            <NavLink to={`/student/student-report-master`}>
              {({isActive}) => (
                <Button
                  variant={isActive ? "gradient" : "text"}
                  onClick={() => {

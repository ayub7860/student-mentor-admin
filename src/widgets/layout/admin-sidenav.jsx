      ...
      <div>
        <ul key={'dashboard'} className='mb-2 mt-0.5 pl-1 flex flex-col gap-1'>
          ...
          <li key={'teacher master'} className="text-md">
            <NavLink to={`/admin/teacher-master`}>
              {({isActive}) => (
                <Button
                  variant={isActive ? "gradient" : "text"}
                  onClick={() => {
          ...
          <li key={'student master'} className="text-md">
            <NavLink to={`/admin/student-master`}>
              {({isActive}) => (
                <Button
                  variant={isActive ? "gradient" : "text"}
                  onClick={() => {
          ...
          <li key={'notice master'} className="text-md">
            <NavLink to={`/admin/notice-master`}>
              {({isActive}) => (
                <Button
                  variant={isActive ? "gradient" : "text"}
                  onClick={() => {
          ...
          <li key={'user master'} className="text-md">
            <NavLink to={`/admin/user-master`}>
              {({isActive}) => (
                <Button
                  variant={isActive ? "gradient" : "text"}
                  onClick={() => {
